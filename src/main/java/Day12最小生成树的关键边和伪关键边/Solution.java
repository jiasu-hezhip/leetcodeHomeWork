...
public class Solution {
    ...
    public static void main(String[] args) {
        int[][] n = {{0,1,1},{1,2,1},{2,3,2},{0,3,2},{0,4,3},{3,4,3},{1,4,6}};
        List<List<Integer>> list = findCriticalAndPseudoCriticalEdges(5,n);
